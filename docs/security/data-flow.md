...
| Blob storage | Attachments, inline images, thumbnails, parser results | Stream directly into versioned chunked AEAD; random names; authenticated metadata; encrypted eviction | Planned |
